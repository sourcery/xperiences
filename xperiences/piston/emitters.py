...
class Emitter(object):
    ...
    def construct(self):
        ...
        def _any(thing, fields=()):
            ...
            if isinstance(thing, QuerySet):
                ...
                ret = self.decode_datetime(thing)
        ...
        def _model(data, fields=()):
            ...
            """
            cache_key = (type(data),data.pk)
            if cache_key in cached_models:
                return cached_models[cache_key]
            ret = { }
            cached_models[cache_key] = ''
            handler = self.in_typemapper(type(data), self.anonymous,data)
            ...
            if handler or fields:
                ...
                if not fields:
                    ...
                    """
                    mapped = self.in_typemapper(type(data), self.anonymous,data)
    ...
    def in_typemapper(self, model, anonymous,data=None):
    ...
    def decode_datetime(self, dt):
        return smart_unicode(dt, strings_only=True)
